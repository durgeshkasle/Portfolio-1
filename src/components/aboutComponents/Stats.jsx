...
const StatCard = styled(Paper)(({ theme }) => ({
  ...
  // Subtle hover effect for visual feedback without suggesting clickability
  '&:hover': {
    transform: 'translateY(-2px)', // Much more subtle lift
    boxShadow: '0 12px 40px rgba(0, 0, 0, 0.35), 0 0 0 1px rgba(202, 175, 92, 0.15)',
    border: '1px solid rgba(202, 175, 92, 0.25)',

    '& svg': {
      transform: 'scale(1.05)', // Subtle icon scaling
