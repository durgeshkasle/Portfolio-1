    ...
    <Box sx={{ py: 8, px: 3 }}>
      ...
      <Typography
        ...
        >
            ...
            problem-solving skills. Each project reflects modern design and scalable
            architecture built with the latest web technologies.
      </Typography>


      <Grid container spacing={5} sx={{display:"flex", justifyContent: {md: "space-between", xs:"center"}}}>
